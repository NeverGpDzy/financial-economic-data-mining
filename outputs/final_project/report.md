...
| trig-5%_exp50% | 20.57% | -10.95% | 1.2058 | 2.10% | 16.7000 | 0.50% | ✗ | ✗ |
| trig-5%_exp40% | 14.58% | -9.87% | 0.9648 | -3.63% | 17.2000 | 0.52% | ✓ | ✓ |
| trig-4%_exp50% | 20.40% | -10.57% | 1.2474 | 1.95% | 17.7000 | 0.53% | ✗ | ✗ |
| trig-4%_exp40% | 14.00% | -9.41% | 0.9728 | -4.19% | 18.4000 | 0.55% | ✓ | ✓ |

![风险控制谱系](risk_spectrum.png)

实证表明：采用 `trig-5%_exp40%` 风控规则可将年化收益压至 14.58%、最大回撤压至 -9.87%，**同时满足 12%-18% 收益与 ≤10% 回撤双目标**，总成本为 0.52%，但代价是在强势年份牺牲基准超额（超额 -3.63%）。这揭示平衡型产品的根本权衡：严守风控红线需让渡部分进攻性。生产中可结合市场状态动态切换激进/保守模式。
